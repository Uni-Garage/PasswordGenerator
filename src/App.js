...
import { COPY_Fail, COPY_FAIL_EMPTY, COPY_SUCCESS } from './message';
...
const App = () => {
  ...
  const handleClearPassword = () => {
    setPassword("");
    // Optionally, you can reset the checkboxes or any other state variables here
    notify("Password generation process has been reset", false);
  };
    ...
    <div className="App">
      <div className="container">
        <div className="generator">
          ...
          <button onClick={handleClearPassword} className="clear__btn">
            clear
          </button>
          <ToastContainer
            position="top-center"
